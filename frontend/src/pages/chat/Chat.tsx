...
import Contoso from "../../assets/inspark.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>InSpark Productcatalogus</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Deze chatbot beantwoord vragen over alle InSpark producten en diensten.</h2>
                            </Stack>
                        ) : (
